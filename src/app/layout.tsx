  ...
  return (
    <header className="lg:sticky lg:top-0 lg:flex lg:h-screen lg:w-1/2 lg:flex-col lg:justify-between lg:py-36 lg:px-6 lg:items-left">
      ...
      <ul className="mt-8 flex items-center gap-5 w-full max-w-md" aria-label="Social media">
        <li>
          <a href="#" className="block text-text-muted hover:text-text-highlight transition-colors" aria-label="GitHub" target="_blank" rel="noreferrer noopener">
        ...
        <li>
          <a href="#" className="block text-text-muted hover:text-text-highlight transition-colors" aria-label="LinkedIn" target="_blank" rel="noreferrer noopener">
        ...
        <li>
          <a href="#" className="block text-text-muted hover:text-text-highlight transition-colors" aria-label="Instagram" target="_blank" rel="noreferrer noopener">
